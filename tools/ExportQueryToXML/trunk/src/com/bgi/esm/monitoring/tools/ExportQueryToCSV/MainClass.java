package com.bgi.esm.monitoring.tools.ExportQueryToCSV;
...
public class MainClass
{
    ...
    private static String output_filename = "query.out.csv";
    ...
    public static void main ( String args[] ) throws ClassNotFoundException, SQLException, IOException
    {
        ...
        if ( true == found_errors )
        {
            ...
            System.err.println ( "    java -jar ExportQueryToCSV -server=? -database=? -port=? -username=? -password=? -dbtype=? -outfile=? <-no-cdata> -query\n" );
            ...
            System.err.println ( "        outfile    Optional.  The name of the output CSV file.  Defaults to \"query.out.csv\"\n" );
            System.err.println ( "" ); 
