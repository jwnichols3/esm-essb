...
public class HttpParameterViewAction extends HttpParameterDispatchAction
{
    /*
     *
     */
    //  XXX___SERIALVER__XXX
    final private static Logger _log           = Logger.getLogger ( HttpParameterViewAction.class );
    ...
    public ActionForward execute ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        //  Business logic
        ActionForward forward = browse ( mapping, form, request, response );
