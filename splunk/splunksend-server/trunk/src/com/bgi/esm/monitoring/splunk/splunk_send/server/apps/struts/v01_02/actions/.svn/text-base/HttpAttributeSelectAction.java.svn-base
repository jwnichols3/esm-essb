...
public class HttpAttributeSelectAction extends HttpAttributeDispatchAction
{
    /*
     *
     */
    //  XXX___SERIALVER__XXX
    final private static Logger _log           = Logger.getLogger ( HttpAttributeSelectAction.class );
    ...
    public ActionForward execute ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        //  Business logic
        ActionForward forward = selectRecord ( mapping, form, request, response );
