...
public class HttpAttributeEditAction extends HttpAttributeDispatchAction
{
    /*
     *
     */
    //  XXX___SERIALVER__XXX
    final private static Logger _log           = Logger.getLogger ( HttpAttributeEditAction.class );
    ...
    public ActionForward execute ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        //  Business logic
        ActionForward forward = edit ( mapping, form, request, response );
