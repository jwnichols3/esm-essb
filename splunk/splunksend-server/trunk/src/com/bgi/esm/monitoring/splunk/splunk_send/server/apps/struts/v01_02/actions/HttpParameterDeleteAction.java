...
public class HttpParameterDeleteAction extends HttpParameterDispatchAction
{
    /*
     *
     */
    //  XXX___SERIALVER__XXX
    final private static Logger _log           = Logger.getLogger ( HttpParameterDeleteAction.class );
