...
public class HttpParameterEditAction extends HttpParameterDispatchAction
{
    /*
     *
     */
    //  XXX___SERIALVER__XXX
    final private static Logger _log           = Logger.getLogger ( HttpParameterEditAction.class );
