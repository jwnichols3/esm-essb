...
public class HttpAttributeAddAction extends HttpAttributeDispatchAction
{
    /*
     *
     */
    //  XXX___SERIALVER__XXX
    final private static Logger _log           = Logger.getLogger ( HttpAttributeAddAction.class );
    ...
    public ActionForward execute ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        //  Business logic
        ActionForward forward = add ( mapping, form, request, response );
