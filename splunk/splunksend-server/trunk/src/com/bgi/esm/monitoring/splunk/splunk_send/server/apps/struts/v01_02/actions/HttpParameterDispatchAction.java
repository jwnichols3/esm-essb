...
import com.bgi.esm.monitoring.splunk.splunk_send.server.apps.struts.v01_02.forms.HttpParameterForm;
...
public class HttpParameterDispatchAction extends BaseDispatchAction
{
    final private static Logger _log = Logger.getLogger ( HttpParameterDispatchAction.class );
    ...
    {
        HttpParameterForm data_form = (HttpParameterForm) form;
        ...
        if ( false == isEnterpriseMode() )
        {
            ...
            IHttpParameter            object_select = finder.select ( PrimaryKey );
        ...
        else
        {
            try
            {
                IHttpParameterRemote bean = (IHttpParameterRemote) getContext().lookup ( "ejb/HttpParameterStateless" );
                IHttpParameter object_select = bean.selectRemote ( PrimaryKey );
                if ( null != object_select )
                {
                    data_form.setValue ( object_select );
                    result = true;
    ...
    public ActionForward add ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        else
        {
            try
            {
                IHttpParameterRemote bean = (IHttpParameterRemote) getContext().lookup ( "ejb/HttpParameterStateless" );
                IHttpParameterFinder finder = Configuration.getInstance().getHttpParameterFinder();
                IHttpParameter object_insert = finder.newInstance();
    ...
    public ActionForward edit ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        {
            IHttpParameterFinder finder = Configuration.getInstance().getHttpParameterFinder();
            IHttpParameter            object_select = finder.select ( data_form.getRowID() );
        ...
        else
        {
            ...
            {
                IHttpParameterRemote bean = (IHttpParameterRemote) getContext().lookup ( "ejb/HttpParameterStateless" );
                IHttpParameter object_select = bean.selectRemote ( data_form.getRowID() );
                if ( null != object_select )
                {
                    object_select.setValue ( data_form );
    ...
    public ActionForward browse ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        List <IHttpParameter> browseRecords = (List <IHttpParameter>) session.getAttribute ( IHttpParameter.SESSION_BROWSE );
        int PageNum        = 0;
        int PageSize       = 0;
        ...
        if ( false == isEnterpriseMode() )
        {
            ...
            session.setAttribute ( IHttpParameter.SESSION_BROWSE, browseRecords );
    ...
    public ActionForward selectRecord ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        if ( false == isEnterpriseMode() )
        {
            ...
            if ( null != object_select )
            {
                session.setAttribute ( IHttpParameter.SESSION_SELECT, object_select );
                result = true;
                if ( _log.isInfoEnabled() )
                {
                    WeakReference <StringBuilder> message = new WeakReference <StringBuilder> ( new StringBuilder() );
