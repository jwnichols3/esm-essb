...
import com.bgi.esm.monitoring.splunk.splunk_send.server.apps.struts.v01_02.forms.HttpHeaderForm;
...
public class HttpHeaderDispatchAction extends BaseDispatchAction
{
    final private static Logger _log = Logger.getLogger ( HttpHeaderDispatchAction.class );
    ...
    {
        HttpHeaderForm data_form = (HttpHeaderForm) form;
        ...
        if ( false == isEnterpriseMode() )
        {
            ...
            IHttpHeader            object_select = finder.select ( PrimaryKey );
        ...
        else
        {
            try
            {
                IHttpHeaderRemote bean = (IHttpHeaderRemote) getContext().lookup ( "ejb/HttpHeaderStateless" );
                IHttpHeader object_select = bean.selectRemote ( PrimaryKey );
                if ( null != object_select )
                {
                    data_form.setValue ( object_select );
                    result = true;
    ...
    public ActionForward add ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        else
        {
            try
            {
                IHttpHeaderRemote bean = (IHttpHeaderRemote) getContext().lookup ( "ejb/HttpHeaderStateless" );
                IHttpHeaderFinder finder = Configuration.getInstance().getHttpHeaderFinder();
                IHttpHeader object_insert = finder.newInstance();
    ...
    public ActionForward edit ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        {
            IHttpHeaderFinder finder = Configuration.getInstance().getHttpHeaderFinder();
            IHttpHeader            object_select = finder.select ( data_form.getRowID() );
        ...
        else
        {
            ...
            {
                IHttpHeaderRemote bean = (IHttpHeaderRemote) getContext().lookup ( "ejb/HttpHeaderStateless" );
                IHttpHeader object_select = bean.selectRemote ( data_form.getRowID() );
                if ( null != object_select )
                {
                    object_select.setValue ( data_form );
    ...
    public ActionForward browse ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        List <IHttpHeader> browseRecords = (List <IHttpHeader>) session.getAttribute ( IHttpHeader.SESSION_BROWSE );
        int PageNum        = 0;
        int PageSize       = 0;
        ...
        if ( false == isEnterpriseMode() )
        {
            ...
            session.setAttribute ( IHttpHeader.SESSION_BROWSE, browseRecords );
    ...
    public ActionForward selectRecord ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        if ( false == isEnterpriseMode() )
        {
            ...
            if ( null != object_select )
            {
                session.setAttribute ( IHttpHeader.SESSION_SELECT, object_select );
                result = true;
                if ( _log.isInfoEnabled() )
                {
                    WeakReference <StringBuilder> message = new WeakReference <StringBuilder> ( new StringBuilder() );
