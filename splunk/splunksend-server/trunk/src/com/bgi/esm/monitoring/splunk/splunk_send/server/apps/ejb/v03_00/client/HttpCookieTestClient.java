...
public class HttpCookieTestClient extends BaseTestClient
{
    final private static Logger _log = Logger.getLogger ( HttpCookieTestClient.class );

    private IHttpCookieRemote bean = null;
    ...
    public void testStateless_InsertSelectUpdateDelete() throws NamingException
    {
        ...
        bean = (IHttpCookieRemote) getContext().lookup ( "ejb/HttpCookieStateless" );
        ...
        IHttpCookie object_select = bean.selectRemote ( object_insert.getRowID() );
    ...
    public void testStateless_InsertOrUpdate() throws NamingException
    {
        ...
        IHttpCookie object_select = bean.selectRemote ( result.getRowID() );
        assertNotNull ( "Could not find test object in database - #1", object_select );
        assertEquals  ( "Selected object and inserted object are not the same", object_insert, object_select );
    ...
    public void testStateful_InsertSelectUpdateDelete() throws NamingException
    {
        ...
        bean = (IHttpCookieRemote) getContext().lookup ( "ejb/HttpCookieStateful" );
        IHttpCookieFinder finder  = Configuration.getInstance().getHttpCookieFinder();
        IHttpCookie object_insert = SampleHttpCookieCreator.createSampleObject ( finder );
        IHttpCookie object_update = SampleHttpCookieCreator.createUpdateObject ( finder );
