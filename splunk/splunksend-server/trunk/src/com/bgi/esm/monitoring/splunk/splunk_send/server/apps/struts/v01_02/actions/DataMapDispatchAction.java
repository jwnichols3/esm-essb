...
import com.bgi.esm.monitoring.splunk.splunk_send.server.apps.struts.v01_02.forms.DataMapForm;
...
public class DataMapDispatchAction extends BaseDispatchAction
{
    final private static Logger _log = Logger.getLogger ( DataMapDispatchAction.class );
    ...
    {
        DataMapForm data_form = (DataMapForm) form;
        ...
        if ( false == isEnterpriseMode() )
        {
            ...
            IDataMap            object_select = finder.select ( PrimaryKey );
        ...
        else
        {
            try
            {
                IDataMapRemote bean = (IDataMapRemote) getContext().lookup ( "ejb/DataMapStateless" );
                IDataMap object_select = bean.selectRemote ( PrimaryKey );
                if ( null != object_select )
                {
                    data_form.setValue ( object_select );
                    result = true;
    ...
    public ActionForward add ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        else
        {
            try
            {
                IDataMapRemote bean = (IDataMapRemote) getContext().lookup ( "ejb/DataMapStateless" );
                IDataMapFinder finder = Configuration.getInstance().getDataMapFinder();
                IDataMap object_insert = finder.newInstance();
    ...
    public ActionForward edit ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        {
            IDataMapFinder finder = Configuration.getInstance().getDataMapFinder();
            IDataMap            object_select = finder.select ( data_form.getRuleID() );
        ...
        else
        {
            ...
            {
                IDataMapRemote bean = (IDataMapRemote) getContext().lookup ( "ejb/DataMapStateless" );
                IDataMap object_select = bean.selectRemote ( data_form.getRuleID() );
                if ( null != object_select )
                {
                    object_select.setValue ( data_form );
    ...
    public ActionForward browse ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        List <IDataMap> browseRecords = (List <IDataMap>) session.getAttribute ( IDataMap.SESSION_BROWSE );
        int PageNum        = 0;
        int PageSize       = 0;
        ...
        if ( false == isEnterpriseMode() )
        {
            ...
            session.setAttribute ( IDataMap.SESSION_BROWSE, browseRecords );
    ...
    public ActionForward selectRecord ( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response )
    {
        ...
        if ( false == isEnterpriseMode() )
        {
            ...
            if ( null != object_select )
            {
                session.setAttribute ( IDataMap.SESSION_SELECT, object_select );
                result = true;
                if ( _log.isInfoEnabled() )
                {
                    WeakReference <StringBuilder> message = new WeakReference <StringBuilder> ( new StringBuilder() );
