...
<table border="0" width="100%">
    <tr>
        <td>
            <center>
                <html:form action="/http_attribute_audit/edit_process" method="post" enctype="multipart/form-data" onsubmit="submitForm(this); return false;">
                    <jsp:include page="http_attribute_audit_form.jsp" />
                    <html:hidden name="http_attribute_audit_form" property="auditRecordID" value='<%= param_map.get ( "PrimaryKey" ) %>' />
                </html:form>
</center>
            </center>
        </td>
