...
public class Responder4_1 {
    ...
    public void runClient() throws Exception {
    	...
    	Responder r3  = bef.selectResponderByMessageKey ( test_message_key );
        if ( null == r3 )
        {
    	...
    	r3  = bef.selectResponderByMessageKey ( test_message_key );
    	System.out.println("select returns:" + r3.getRowKey() );
    ...
    public static void main(String[] args) throws Exception {
	    ...
	    Responder4_1 sc = new Responder4_1();
	    sc.runClient();
