...
import com.bgi.esm.monitoring.platform.buss_module.dispatcher.ServiceCenter.ServiceCenterProperties;
...
public class ServiceCenter
{
    ...
    public Recordset sendRequest(String ticketNumber, Schema responseSchema) throws IOException, JAXBException
    {
        ...
        Recordset ticket = parseResponse( conn.getInputStream(), responseSchema );
    ...
    public Reader getReaderForRequest(String ticketNumber) throws IOException
    {
    	URL requestUrl = makeRequestUrl(ticketNumber);
    	HttpURLConnection conn = makeConnection(requestUrl);
    ...
    {
        JAXBContext jaxbContext = JAXBContext.newInstance( com.bgi.esm.monitoring.platform.buss_module.dispatcher.ServiceCenter.ticket.ObjectFactory.class );
