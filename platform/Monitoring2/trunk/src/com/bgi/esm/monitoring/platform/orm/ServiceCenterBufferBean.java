...
/**
 * Entity bean supporting ServiceCenterBuffer
 * 
 * @ejb.bean 
 *   name="ServiceCenterBufferEjb" 
 *   type="CMP" 
 *   cmp-version="2.x" 
 *   reentrant="false"
 *   view-type="local" 
 *   local-jndi-name="${jndi.base}/ServiceCenterBufferEjbLocalHome"
 *   description="servicecenter bean"
 * 
 * @ejb.persistence table-name="service_center_buffer"
 *
 * @ejb.finder 
 *   signature="java.util.Collection findAll()" 
 *   query="SELECT OBJECT(x) FROM ServiceCenterBufferEjb AS x ORDER BY x.timestamp ASC" 
 *   unchecked="true"
 * 
 * @ejb.finder 
 *   signature="ServiceCenterBufferLocal findByKey(java.lang.String key)"
 *   query="SELECT OBJECT(x) FROM ServiceCenterBufferEjb AS x WHERE x.rowKey = ?1"
 *   unchecked="true"
 *
 * @ejb.finder 
 *   signature="ServiceCenterBuffer findByTicketNumber(java.lang.String key)"
 *   query="SELECT OBJECT(x) FROM ServiceCenterBufferEjb AS x WHERE x.ticketNum = ?1"
 *   unchecked="true"
 * 
 * @ejb.finder 
 *   signature="java.util.Collection findByMessageKey(java.lang.String key)"
 *   query="SELECT OBJECT(x) FROM ServiceCenterBufferEjb AS x WHERE x.messageKey LIKE ?1 ORDER BY x.timestamp DESC"
 *   unchecked="true"
 * 
 ...
 *
 * @weblogic.cache max-beans-in-cache="5120"
 * 
 * @author Dennis Lin (dept=Enterprise Systems Management, username=linden)
 */
public abstract class ServiceCenterBufferBean implements EntityBean {
	 ...
	 * @ejb.create-method
	 */
	public ServiceCenterBufferEjbPK ejbCreate(ServiceCenterBufferEjbPK key, ServiceCenter arg) throws CreateException {
