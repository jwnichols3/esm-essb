...
public class Responder5 {
    ...
    public void runClient() throws Exception {
        ...
        r1.setServiceCenterTicketNumber ( "IM-Default" );
    	...
    	Responder r3  = bef.findResponderByServiceCenterTicketNumber ( "IM-Default" );
        if ( null == r3 )
        {
        ...
        r2.setServiceCenterTicketNumber ( "alarmpoint_only" );
    	...
    	r3  = bef.findResponderByServiceCenterTicketNumber ( "alarmpoint_only" );
