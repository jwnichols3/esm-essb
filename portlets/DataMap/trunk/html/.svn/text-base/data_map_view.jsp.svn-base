...
<%
    ...
    List <DataMap> records = DataMap.retrieveRecordsPage ( page_num, num_records_per_page );
            ...
            <center>
                <table border="0" width="85%">
                    <tr>
	                    ...
	                    {
	                    %>
	                     <html:form action="data_map_search_process.do?method=search" method="post" onsubmit="submitForm ( this ); return false;">
	                     	<td align="center">Search <bean:message bundle="databases" key="databases.test_datamap.data_map.bgi_group.display_name"/></td>
	                     	<td><html:text name="data_map_form" property="bgiGroup" size="30" /><html:submit>Search</html:submit></td>
	                     </html:form>
	                     <%
	                    }
	                    else
                        ...
                        if ( page_num > 0 )
                        {
                         %><td><html:link action='<%= "/data_map_view?page_num=" + (page_num-1) %>'><bean:message bundle="databases" key="databases.records.prev"/></html:link></td><%
                        }
                        else
                        {
                         %><td>&nbsp;</td><%
                        ...
                        {
                         %><td><html:link action='<%= "/data_map_view?page_num=" + (page_num+1) %>'><bean:message bundle="databases" key="databases.records.next"/></html:link></td><%
                        }
                        else
                        {
                         %><td>&nbsp;</td><%
