package com.bgi.esm.monitoring.portlets.EnterpriseEventBusTestUtility;
...
public class Toolkit
{
    ...
    final public static SimpleDateFormat sdf     = new SimpleDateFormat ( "dd MM yyyy, HH:mm:ss" );
