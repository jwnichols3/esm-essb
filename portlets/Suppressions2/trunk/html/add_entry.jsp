...
<jsp:useBean id="data_form" scope="request" class="com.bgi.esm.monitoring.portlets.Suppressions.forms.AddEntry" />
<%
    ...
    {
%>
<center>Please Sign in First</center>
<%
    }
    else
    {
...
<script language="javascript">
    ...
    {
        var node_value = strTrim ( document.suppression_add_entry.searchNodes.value );

        if ( node_value == initialText)
        {
            document.suppression_add_entry.searchNodes.value = "";
        }
        else if (strTrim(document.suppression_add_entry.searchNodes.value) == "") 
        {
            //document.suppression_add_entry.searchNodes.value = initialText;
        }
    }

    function searchNodesOnblur()
    {
        var node_value = document.suppression_add_entry.node.value;
        ...
        {
            document.suppression_add_entry.searchNodes.value = document.suppression_add_entry.node.value;
        }
    }

    function searchNodesOnkeyup() 
    {
        var mbrName = strTrim(document.suppression_add_entry.searchNodes.value);

        if (mbrName == "") 
        {
            document.suppression_add_entry.mrc.options[0].selected=true;
            document.suppression_add_entry.searchNodes.value = initialText;
            return;
        }
        else if (mbrName.substring(0, initialText.length) == initialText) 
        {
            ...
            document.suppression_add_entry.searchNodes.value = justMbr;
            mbrName = justMbr.toUpperCase();
        }
        else {mbrName = mbrName.toUpperCase();}

        for (var i=0; i < document.suppression_add_entry.node.options.length; i++) {

            var mName = strTrim(document.suppression_add_entry.node.options[i].value.toUpperCase());
            ...
            {
                document.suppression_add_entry.byNode.checked=true;
                document.suppression_add_entry.node.options[i].selected=true;
                return;
            }
        }
    }
    ...
    {
        if (strTrim(document.suppression_add_entry.searchApps.value) == initialText) 
        {
            document.suppression_add_entry.searchApps.value = "";
        }
        else if (strTrim(document.suppression_add_entry.searchApps.value) == "") 
        {
            //document.suppression_add_entry.searchApps.value = initialText;
        }
    }

    function searchAppsOnblur()
    {
        var node_value = document.suppression_add_entry.application.value;
        ...
        {
            document.suppression_add_entry.searchApps.value = node_value;
        }
    }

    function searchAppsOnkeyup() 
    {
        var mbrName = strTrim(document.suppression_add_entry.searchApps.value);

        if (mbrName == "") 
        {
            document.suppression_add_entry.application.options[0].selected=true;
            document.suppression_add_entry.searchApps.value = initialText;
            return;
        }
        else if (mbrName.substring(0, initialText.length) == initialText) 
        {
            var justMbr = mbrName.substring(initialText.length, mbrName.length);
            document.suppression_add_entry.searchApps.value = justMbr;
            mbrName = justMbr.toUpperCase();
        }
        else {mbrName = mbrName.toUpperCase();}

        for (var i=0; i < document.suppression_add_entry.application.options.length; i++) {

            var mName = strTrim(document.suppression_add_entry.application.options[i].value.toUpperCase());

            // Check to see if any member name begins with the typed char(s).
            // If so, scroll to that name in the picklist.
            if (mName.indexOf(mbrName) == 0) 
            {
                document.suppression_add_entry.byApplication.checked =true;
                document.suppression_add_entry.application.options[i].selected=true;
                return;
            }
        }
    }
    ...
    {
        if (strTrim(document.suppression_add_entry.searchDbServer.value) == initialText) 
        {
            document.suppression_add_entry.searchDbServer.value = "";
        }
        else if (strTrim(document.suppression_add_entry.searchDbServer.value) == "") 
        {
            //document.suppression_add_entry.searchDbServer.value = initialText;
        }
    }

    function searchDbServerOnblur()
    {
        node_value = document.suppression_add_entry.dbServer.value;
        ...
        {
            document.suppression_add_entry.searchDbServer.value = node_value;
        }
    }

    function searchDbServerOnkeyup() 
    {
        var mbrName = strTrim(document.suppression_add_entry.searchDbServer.value);
        ...
        {
            var justMbr = mbrName.substring(initialText.length, mbrName.length);
            document.suppression_add_entry.searchDbServer.value = justMbr;
            mbrName = justMbr.toUpperCase();
        }
        else {mbrName = mbrName.toUpperCase();}

        for (var i=0; i < document.suppression_add_entry.dbServer.options.length; i++) 
        {
            ...
            if (mName.indexOf(mbrName) == 0) 
            {
                document.suppression_add_entry.withDbServer.checked = true;
                document.suppression_add_entry.withDbServerInstance.checked = true;
                document.suppression_add_entry.dbServer.options[i].selected=true;
                return;
            }
        }
    }
    ...
    {
        var input_textbox = document.suppression_add_entry.node;
    ...
    function changeApp()
    {
        var value = document.suppression_add_entry.application.value;
        ...
        {
            document.suppression_add_entry.byApplication.checked = false;
        }
    }

    function changeNode()
    {
        var value = document.suppression_add_entry.node.value;
        ...
        {
            document.suppression_add_entry.byNode.checked = false;
        }
    }
                ...
                <html:form action="/add_entry_process" method="post" onsubmit="submitForm(this); return false;">
                    <table border="1">
                        ...
                        <tr>
                            ...
                            <td>
                                <html:select name="suppression_add_entry" property="application" onchange="javascript:changeApp()" >
                        ...
                        <tr>
                            ...
                            <td>
                                <html:select name="suppression_add_entry" property="node" onchange="javascript:changeNode()" >
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <html:select name="suppression_add_entry" property="dbServer" >
...
<script language="Javascript">
    function initStartEndTime()
    {
        <%
         ...
         %>
        document.suppression_add_entry.supStartDate.value   = "<%= calendar.get ( Calendar.DATE )   %>";
        document.suppression_add_entry.supStartMonth.value  = "<%= calendar.get ( Calendar.MONTH )  %>";
        document.suppression_add_entry.supStartYear.value   = "<%= calendar.get ( Calendar.YEAR )   %>";
        document.suppression_add_entry.supStartHour.value   = "<%= calendar_hour                    %>";
        document.suppression_add_entry.supStartMinute.value = "<%= calendar.get ( Calendar.MINUTE ) %>";
        document.suppression_add_entry.supStartAmpm.value   = "<%= am_pm %>";

        document.suppression_add_entry.supEndDate.value     = "<%= calendar.get ( Calendar.DATE )   %>";
        document.suppression_add_entry.supEndMonth.value    = "<%= calendar.get ( Calendar.MONTH )  %>";
        document.suppression_add_entry.supEndYear.value     = "<%= calendar.get ( Calendar.YEAR )   %>";
        document.suppression_add_entry.supEndHour.value     = "<%= calendar_hour                    %>";
        document.suppression_add_entry.supEndMinute.value   = "<%= calendar.get ( Calendar.MINUTE ) %>";
        document.suppression_add_entry.supEndAmpm.value     = "<%= am_pm %>";
    }
    ...
    document.suppression_add_entry.setAttribute ( "autocomplete", "off" );
    initStartEndTime();
</script>
<%
    }
