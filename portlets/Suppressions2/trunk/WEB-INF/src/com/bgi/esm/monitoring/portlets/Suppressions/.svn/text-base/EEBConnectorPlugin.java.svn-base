...
import com.bgi.esm.monitoring.portlets.Suppressions.Mailer;
...
public class EEBConnectorPlugin implements PlugIn {
	...
	public void init ( final ActionServlet servlet, final ModuleConfig config) throws ServletException 
    {
		...
		System.err.println ( "///com.bgi.esm.monitoring.portlets.Suppressions::EEBConnectorPlugin struts plugin start///" );
		_log.trace ( "//com.bgi.esm.monitoring.portlets.Suppressions::EEBConnectorPlugin struts trace level test message" );
		_log.debug ( "//com.bgi.esm.monitoring.portlets.Suppressions::EEBConnectorPlugin struts debug level test message" );
		_log.info  ( "//com.bgi.esm.monitoring.portlets.Suppressions::EEBConnectorPlugin struts info level test message"  );
		_log.warn  ( "//com.bgi.esm.monitoring.portlets.Suppressions::EEBConnectorPlugin struts warn level test message"  );
		_log.error ( "//com.bgi.esm.monitoring.portlets.Suppressions::EEBConnectorPlugin struts error level test message" );
	...
	public void destroy() 
    {
		System.err.println("///com.bgi.esm.monitoring.portlets.Suppressions.EEBConnectorPlugin struts plugin stop///");
	}

	/**
	 * PlugIn target
	 */
	public static final String TARGET1 = "com.bgi.esm.monitoring.portlets.Suppressions.EEBConnectorPlugin";
