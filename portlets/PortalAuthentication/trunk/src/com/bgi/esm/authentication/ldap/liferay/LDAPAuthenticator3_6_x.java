...
public class LDAPAuthenticator3_6_x implements Authenticator
{
    final private static Logger _log = Logger.getLogger ( LDAPAuthenticator3_6_x.class );
    ...
    public int authenticateByUserId( String companyId, String user_id, String password) throws AuthException
    {
        /*
        ...
        try
        {
            ...
            if ( ldap.doesUserExist ( user_id, password ) )
            {
                ...
                try 
                {
                    ...
                    //  User exists.  So now, we update the user
                    user = UserLocalServiceUtil.updateUser( user_id, password, password, false );
    ...
    // Required to not break the build for Liferay 4.2.x
