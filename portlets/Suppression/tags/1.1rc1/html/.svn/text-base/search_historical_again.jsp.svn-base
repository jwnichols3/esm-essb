...
<%
 ...
 %>
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td>
                <b>Re-organizing Search Results for All Historical Entries</b>
				<br />
				<br />
                        ...
                        <%
							while ( results.next() )
                            {
                                ...
                                if ( show_suppress_id )
                                {
                                    ...
                                    if ( null != username )
                                    {
                                        %><th><html:link styleId="suppressionEntryLink" action="<%= "/view_entry?suppress_id="+suppress_id %>"><%= suppress_id %></html:link></td><%
                                    }
                                    else
                                    {
                                        %><td><%= suppress_id %></td><%
