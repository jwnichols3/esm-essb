...
<%@ page import="com.bgi.esm.portlets.Suppression.forms.EditEntry" %>
<jsp:useBean id="entry_form" scope="request" class="com.bgi.esm.portlets.Suppression.forms.EditEntry" />
<%
