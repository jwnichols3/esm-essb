...
public class AddSuppressionTool
{
    ...
    public static void main ( String args[] ) throws Exception
    {
        ...
        //int num_records = stmt.executeUpdate ( "UPDATE t_vpo_suppress SET deleted_flg='y' WHERE message LIKE '%test db server message%'" );
        //ResultSet results = stmt.executeQuery ( "SELECT suppress_id FROM t_vpo_suppress WHERE message LIKE '%\n%'" );

        /*
        while ( results.next() )
        {
            System.out.println ( "Suppress ID: " + results.getInt ( 1 ) );
        }
        //*/
