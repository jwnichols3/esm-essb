 ...
 *
 */
public class AddEntry extends ActionForm implements SuppressionDate {
    /**
     * 
     */
    ...
    final private static Logger _log           = Logger.getLogger ( AddEntry.class );
    ...
    public void setSupStartDate ( String param ) {
        _sup_start_date = df.format ( Integer.parseInt ( param ) );
    }
    ...
    public void setSupStartHour ( String param ) {
        _sup_start_hour = df.format ( Integer.parseInt ( param ) );
    }
    ...
    public void setSupStartMinute ( String param ) {
        _sup_start_minute = df.format ( Integer.parseInt ( param ) );
    }
    ...
    public void setSupStartMonth ( String param ) {
        _sup_start_month = df.format ( Integer.parseInt ( param ) );
    }
    ...
    public void setSupEndMonth ( String param ) {
        _sup_end_month = df.format ( Integer.parseInt ( param ) );
    }
    ...
    public void setSupEndDate ( String param ) {
        _sup_end_date = df.format ( Integer.parseInt ( param ) );
    }
    ...
    public void setSupEndHour ( String param ) {
        _sup_end_hour = df.format ( Integer.parseInt ( param ) );
    }
    ...
    public void setSupEndMinute ( String param ) {
        _sup_end_minute = df.format ( Integer.parseInt ( param ) );
    }
	...
	private void LogToFile ( String message )
    {
        try
        {
            FileOutputStream outfile = new FileOutputStream ( "c:\\test\\AddEntryForm", true );
    ...
    public ActionErrors validate( ActionMapping mapping, HttpServletRequest request ) 
    {
        ...
        _log.info ( "Retrieving start/stop times from form" );

        if ( _log.isDebugEnabled() )
        {
            DumpToFile ( "c:/SourceForge/liferay/ext/servers/tomcat/logs/form_dump.html" );
        }

        if ( _log.isInfoEnabled() )
        {
            WeakReference <StringBuilder> message1 = new WeakReference <StringBuilder> ( new StringBuilder() );
            message1.get().append ( "Start Date from Request: " );
            message1.get().append ( getSupStartYear()   );
            message1.get().append ( getSupStartMonth()  );
            message1.get().append ( getSupStartDate()   );
            message1.get().append ( " " );
            message1.get().append ( getSupStartHour()   );
            message1.get().append ( getSupStartMinute() );
            message1.get().append ( " " );
            message1.get().append ( getSupStartAmpm()   );
            _log.info ( message1.get().toString() );

            WeakReference <StringBuilder> message2 = new WeakReference <StringBuilder> ( new StringBuilder() );
            message2.get().append ( "End Date from Request: " );
            message2.get().append ( getSupEndYear()   );
            message2.get().append ( getSupEndMonth()  );
            message2.get().append ( getSupEndDate()   );
            message2.get().append ( " " );
            message2.get().append ( getSupEndHour()   );
            message2.get().append ( getSupEndMinute() );
            message2.get().append ( " " );
            message2.get().append ( getSupEndAmpm()   );
        ...
        _log.info ( "\tStart: " + sup_start_date.toString() );
        _log.info ( "\tEnd:   " + sup_end_date.toString() );

        int timezone_offset = Integer.parseInt ( getTimeZoneOffset() );
       
        //  If we are using a specified date for the start date, we need to make sure that the 
        //  offset gets applied
        if ( !getStartChoice().equals ( "now" ) )
        {
            _log.info ( "Specified start time" );
            sup_start_date  = new Date ( sup_start_date.getTime() - timezone_offset );
        }

        if ( !getEndChoice().equals ( "offset" ) )
        {
            _log.info ( "Specified end time" );
            //sup_end_date  = new Date ( sup_end_date.getTime() - timezone_offset );
        }
        else
        {
            _log.info ( "End time type: " + getEndChoice() );
        }
        sup_end_date  = new Date ( sup_end_date.getTime() - timezone_offset );

        _log.info ( "Add suppression validation: " );
        _log.info ( "\tStart:  " + sup_start_date.toString() );
        _log.info ( "\tEnd:    " + sup_end_date.toString() );
        _log.info ( "\tOffset: " + timezone_offset );
        ...
        {
            StringBuilder message = new StringBuilder ( "The SPECIFIED end date ( " );
            message.append ( sup_end_date.toString() );
            message.append ( ", " );
            message.append ( date_end );
            message.append ( " ) for this suppression is before the current date ( " );
            message.append ( date_now );
            message.append ( " )" );
        ...
        {
            _log.error ( "You must specify either at least a node or an application" );
    ...
    {
        return _user_timestamp;
    }

    public void setUserTimestamp ( String new_timestamp )
    {
        _user_timestamp = new_timestamp;
    }
	...
	private String _user_timestamp          = "";
