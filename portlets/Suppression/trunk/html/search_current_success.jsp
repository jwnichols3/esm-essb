...
<%
    ...
    int suppress_id                  = 0;
    String struts_path               = "/search_current_again";
    ...
    ResultSet results                = Toolkit.retrieveCurrent ( renderRequest, description, app_name, node, dbServer, dbServerMsg, startDate, endDate, status_reboot.intValue(), status_deleted.intValue(), search_username, sort_type );
...
%>
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td>
                <b>Searching All Current Entries</b>
                <br />
                <br />
                        ...
                        <%
							while ( results.next() )
                            {
                                ...
                                if ( show_suppress_id )
                                {
                                    ...
                                    {
                                        %><td><html:link styleId="suppressionEntryLink" styleId="suppressionEntryLink" action="<%= "/view_entry?suppress_id="+suppress_id %>"><%= suppress_id %></html:link></td><%
                                    }
                                    else
                                    {
                                        %><td><%= suppress_id %></td><%
                                ...
                                if ( show_suppression_creator )
                                {
                                    creator = Toolkit.checkDisplayString ( results.getString ( "create_nm" ) );
                                    %><td><%= creator %></td><%
                                }
                                if ( show_remove_on_reboot )
                                {
