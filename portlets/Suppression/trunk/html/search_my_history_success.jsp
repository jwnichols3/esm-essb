...
%>
    ...
    <table border="0" width="100%">
        ...
        <tr>
            <td>
                <b>Searching My Historical Entries</b> for <%= username %>
                <br />
                <br />
                        ...
                        <%
							while ( results.next() )
                            {
                                ...
                                if ( show_suppress_id )
                                {
                                    ...
                                    %><td><html:link action="<%= "/view_entry?suppress_id="+suppress_id %>"><%= suppress_id %></html:link></td><%
                                }
                                if ( show_group_name )
                                {
                                ...
                                if ( show_suppression_creator )
                                {
                                    ...
                                    %><td><html:link action="<%= "/view_entry?suppress_id="+suppress_id %>"><%= creator %></html:link></td><%
                                }
                                if ( show_remove_on_reboot )
                                {
