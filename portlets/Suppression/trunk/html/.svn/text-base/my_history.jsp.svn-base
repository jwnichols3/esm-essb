...
<%
    ...
    ResultSet results                = Toolkit.getHistoricalSuppressions ( renderRequest, username );
                        ...
                        <%
							while ( results.next() )
                            {
                                ...
                                if ( show_suppress_id )
                                {
                                    ...
                                    %><td><html:link styleId="suppressionEntryLink" action="<%= "/view_entry?suppress_id="+suppress_id %>"><u><%= suppress_id %></u></html:link></td><%
                                }
                                if ( show_group_name )
                                {
                                ...
                                if ( show_remove_on_reboot )
                                {
                                    ...
                                    %><td nowrap><center><%= reboot_text %></center></td><%
                                }
                                 %>
                                </tr>
                                <%
