...
public class TTIEventForm extends ActionForm
{
    final private static Logger _log = Logger.getLogger ( TTIEventForm.class );
    ...
    {
        _log.debug ( "TTIEvent::reset()" );
    }

    public ActionErrors validate ( ActionMapping mapping, HttpServletRequest request )
    {
        _log.debug ( "TTIEvent::validate()" );
    ...
    public String toString()
    {
        ...
        message.get().append ( "TTI Event from Openview ( Messageid=" );
