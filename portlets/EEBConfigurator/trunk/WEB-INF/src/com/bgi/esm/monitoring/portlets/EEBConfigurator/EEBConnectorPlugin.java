package com.bgi.esm.monitoring.portlets.EEBConfigurator;
...
public class EEBConnectorPlugin implements PlugIn {
	...
	private void discoverFrameWorkDatum ( final PlugInConfig[] argz ) 
    {
		...
		if ( flag ) 
        {
			_log.error( "EEBConnectorPlugin not discovoered");
		}
	}
	 ...
	 * PlugIn target
	 */
	public static final String TARGET1 = "com.bgi.esm.monitoring.portlets.EEBConfigurator.EEBConnectorPlugin";
